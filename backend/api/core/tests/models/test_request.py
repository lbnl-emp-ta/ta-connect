...
class TestRequestModel:
    def test_request_model_raises_integrity_error_when_proj_start_date_after_proj_completion_date(
        self,
    ):
        """
        ...
        request = Request(description="test", proj_completion_date=completion_date)
    ...
    def test_request_model_raises_integrity_error_when_proj_completion_date_before_proj_start_date(
        self,
    ):
        """
        ...
        request = Request(description="test", proj_start_date=start_date)
