...
class TestRequestDetailViewEndpoint:
    def test_request_detail_get_view_should_fail_when_missing_admin_header(
        self, api_client
    ):
    ...
    def test_request_detail_patch_view_should_fail_when_missing_admin_header(
        self, api_client
    ):
        # User with pk=1 should be an Admin
        api_client.force_login(User.objects.get(pk=1))
    ...
    def test_request_detail_patch_view_should_fail_when_not_authorized(
        self, api_client
    ):
        response = api_client.patch("/api/requests/1")
    ...
    def test_request_detail_patch_view_should_succeed_when_patching_description(
        self, api_client
    ):
