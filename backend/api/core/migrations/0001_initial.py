    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone",
                    models.CharField(
                        default=None, max_length=64, verbose_name="phone number"
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="core.organizationtype"
            ),
        ),
        migrations.CreateModel(
            name="Request",
            fields=[
                ...
                (
                    "depth",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="core.depth"
                    ),
                ),
                (
                    "status",
                    models.ForeignKey(
                        default=core.models.request_status.RequestStatus.get_default_pk,
                        on_delete=django.db.models.deletion.PROTECT,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="core.CustomerRequestRelationship",
                to="core.request",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "customers",
                    models.ManyToManyField(
                        blank=True, related_name="cohort", to="core.customer"
                    ),
                ),
                (
                    "request",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT,
                to="core.transmissionplanningregion",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("proj_completion_date__gt", models.F("proj_start_date")),
                    ("proj_start_date__isnull", True),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("proj_start_date__lt", models.F("proj_completion_date")),
                    ("proj_completion_date__isnull", True),
                    _connector="OR",
                ),
