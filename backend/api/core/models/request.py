...
class Request(models.Model):
    ...
    owner = models.ForeignKey(
        ...
        blank=True,
        null=True,
        default=Owner.get_default_pk,
    )
    program = models.ForeignKey(
        Program, on_delete=models.PROTECT, blank=True, null=True
    )
    ...
    status = models.ForeignKey(
        RequestStatus, on_delete=models.PROTECT, default=RequestStatus.get_default_pk
    )
    depth = models.ForeignKey(
        ...
        blank=True,
        null=True,
        default=Depth.get_default_pk,
    )
    description = models.TextField(blank=True, null=True)
    challenges = models.TextField(blank=True, null=True)
    goals = models.TextField(blank=True, null=True)
    effort = models.CharField(
        max_length=25, choices=EffortLevel.choices, blank=True, null=True
    )
    date_created = models.DateTimeField(auto_now_add=True)
    proj_start_date = models.DateField(
        blank=True, null=True, verbose_name="projected start date"
    )
    proj_completion_date = models.DateField(
        blank=True, null=True, verbose_name="projected completion date"
    )
    ...
    class Meta:
        ...
        constraints = [
            ...
            CheckConstraint(
                condition=Q(proj_completion_date__gt=F("proj_start_date"))
                | Q(proj_start_date__isnull=True),
            ...
            CheckConstraint(
                condition=Q(proj_start_date__lt=F("proj_completion_date"))
                | Q(proj_completion_date__isnull=True),
